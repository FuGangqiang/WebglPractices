...
static VERT_SHADER_SRC: &'static str = include_str!("./vertex-shader.essl");
static FRAG_SHADER_SRC: &'static str = include_str!("./fragment-shader.essl");
...
impl Shader {
    ...
    pub fn triangle_shader(gl: &GL) -> Result<Shader, JsValue> {
        Self::new(gl, VERT_SHADER_SRC, FRAG_SHADER_SRC)
    }
