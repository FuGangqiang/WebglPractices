...
static VERT_SHADER_SRC: &'static str = include_str!("./vertex-shader.glsl");
static FRAG_SHADER_SRC: &'static str = include_str!("./fragment-shader.glsl");
...
impl Shader {
    ...
    pub fn default_shader(gl: &GL) -> Result<Shader, JsValue> {
